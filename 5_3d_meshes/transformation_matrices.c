...
int main(int argc, char *argv[]) {
	...
	WGPUShaderModule shaderModule = loadShaderModule(RESOURCE_DIR "/transformation_matrices.wsl", device);
	...
	WGPUDepthStencilState depthStencilState = DEFAULT_DEPTH_STENCIL;
	...
	glm_mat4_identity(uniforms.viewMatrix);
	glm_mat4_identity(uniforms.modelMatrix);
	glm_perspective(45.0f, 640.0f / 480.0f, 0.001f, 100.0f, uniforms.projectionMatrix);

	printf("uniforms.time size: %lu \n", sizeof(float));
	printf("uniforms.color size: %lu \n", sizeof(float[4]));
	printf("uniforms._pad size: %lu \n", sizeof(float[3]));
	printf("uniforms.projectionMatrix size: %lu \n", sizeof(mat4));
	printf("uniforms.viewMatrix size: %lu \n", sizeof(mat4));
	printf("uniforms.modelMatrix size: %lu \n", sizeof(mat4));
	printf("uniforms size: %lu \n", sizeof(MyUniforms));
